...
public class Coffee extends Item{
        private static final FoodProperties food = ((new FoodProperties.Builder()).effect(() -> new MobEffectInstance(EffectRegistry.Cofe.get(), 120 * 20, 0), (float) 1).build());

        public Coffee(Item.Properties properties) {
        ...
        public void appendHoverText(ItemStack items, @Nullable Level world, List<Component> list, TooltipFlag data) {
            list.add(new TranslatableComponent("info.coffee.food").withStyle(ChatFormatting.GRAY));
        }
}
